...
public class AddPrescriptionActivity extends AppCompatActivity {
    ...
    LinearLayout cameraLL, galleryLL, sendPrescriptionLL;
    ImageView chosenImageIV, removeImageIV;
    TextView doctorNameET, noteET,testing2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendPrescriptionLL = findViewById(R.id.sendPrescriptionLL);
        chosenImageIV = findViewById(R.id.chosenImageIV);
        removeImageIV = findViewById(R.id.removeImageIV);
    ...
    private void setClickListeners() {
        cameraLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (PermissionUtils.isCameraPermissionGranted(AddPrescriptionActivity.this, "", 1)) {
                    Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                    if (file != null) {
                        Uri photoURI = FileProvider.getUriForFile(AddPrescriptionActivity.this, "com.example.android.fileProvider", file);
        ...
        galleryLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (PermissionUtils.isStoragePermissionGranted(AddPrescriptionActivity.this, "", PICK_PICTURE)) {
        ...
        sendPrescriptionLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(!doctorNameET.getText().toString().isEmpty() || !noteET.getText().toString().
                        isEmpty() && currentPhotoPath !=null) {
                    addPrescription(new File(currentPhotoPath), doctorNameET.getText().toString(), noteET.getText().toString());
                } else {
                    Toast.makeText(AddPrescriptionActivity.this, "Please upload prescription or doctor name or note", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        testing2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddPrescriptionActivity.this, ConfirmationActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TAKE_PICTURE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                chosenImageIV.setImageURI(contentUri);
                setCategoryImage();
            }
        } else if (requestCode == PICK_PICTURE) {
            if (resultCode == Activity.RESULT_OK) {
                setCategoryImage();
                chosenImageIV.setImageURI(data.getData());
    ...
    private void setCategoryImage() {
        chosenImageIV.setVisibility(View.VISIBLE);
    }
        ...
        responseCall.enqueue(new Callback<RegisterResponse>() {
            ...
            public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(AddPrescriptionActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                } else {
                    progressDialog.dismiss();

                    Toast.makeText(AddPrescriptionActivity.this, "Upload Failed", Toast.LENGTH_SHORT).show();
                }
            }
